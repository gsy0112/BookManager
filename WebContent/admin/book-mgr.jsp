    ...
    <div id="container">
    	...
    	<div id="main">
				...
				<table class="table" cellspacing="0" style="font-size: 12px;">
			    	...
			    	<c:forEach items="${pg.pageLists }" var="b">
			    		<tr>
				    		...
				    		<td><a href="${pageContext.request.contextPath}/BookController?op=delete">删除</a>&nbsp;<a href="${pageContext.request.contextPath}/BookController?op=FindById?id=${b.price }">编辑</a></td>
				    	</tr>
			    	</c:forEach>
			    </table>
			    <div class="paging">
			...
			<div class="section-right">
				<h2>添加图书信息</h2>
				<form action="${pageContext.request.contextPath}/BookController?op=save" method="post">
